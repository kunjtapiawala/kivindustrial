        ...
        <section className="mx-auto flex max-w-5xl flex-col gap-8 px-4 py-16 sm:px-6 sm:py-24" id="hero">
          <div className="space-y-6 text-center sm:text-left">
            ...
            <p className="text-base text-muted sm:max-w-xl">
              KIV Industrial sources your parts from a network of trusted distributors and suppliers across the United States, giving you access to over 3 million parts. Same-day or next-day shipping available, with lead times near zero for most orders.
            </p>
